...
class CadastroOvinoPage extends StatefulWidget {
  final Animal animalOvino;

  CadastroOvinoPage({this.animalOvino});

  @override
  _CadastroOvinoPageState createState() => _CadastroOvinoPageState();
}

class _CadastroOvinoPageState extends State<CadastroOvinoPage> {
  ...
  void initState() {
    ...
    if (widget.animalOvino == null) {
      _editedAnimal = Animal();
    } else {
      _editedAnimal = Animal.fromMap(widget.animalOvino.toMap());
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
          ...
          title: Text(_editedAnimal.nome ?? "Novo Ovino"),
          centerTitle: true,
        ),
